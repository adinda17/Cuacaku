...
public class HujanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //image button intent
        ImageButton laguHujan = (ImageButton) findViewById(R.id.lagu_hujan);

        laguHujan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HujanActivity.this, "clicked", Toast.LENGTH_LONG).show();

                Intent Lhujan = new  Intent(HujanActivity.this, LhujanActivity.class);
                startActivity(Lhujan);
            }
        });
    }
...
//        Editable ceritaEditable = ceritaField.getText();
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Catatan kesedihan mu " + name);
    ...
    private String createOrderSummary(String name, String cerita, int price,boolean addFamily, boolean addPacar , boolean 	addStranger , boolean addTeman) {
        ...
        priceMessage += "\n" + getString(R.string.order_summary_family2, addFamily);
        priceMessage += "\n" + getString(R.string.order_summary_pacar2, addPacar);
        priceMessage += "\n" + getString(R.string.order_summary_stranger2, addStranger);
        priceMessage += "\n" + getString(R.string.order_summary_teman2, addTeman);
        priceMessage += "\n" + getString(R.string.order_summary_quantity2, quantity);
        priceMessage += "\n" + getString(R.string.order_summary_cerita, cerita);
        priceMessage += "\n" + getString(R.string.order_summary_price2,
